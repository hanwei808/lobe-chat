---
title: Using Stepfun API Key in WodeChat
description: >-
  Learn how to integrate Stepfun AI models into WodeChat for engaging conversations. Obtain Stepfun API key, configure Stepfun in WodeChat settings, and select a model to start chatting.
...
# Using Stepfun in WodeChat

<Image alt={'Using Stepfun in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563'} />
...
This document will guide you on how to use Stepfun in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in WodeChat
...
You can now use the models provided by Stepfun to have conversations in WodeChat.
