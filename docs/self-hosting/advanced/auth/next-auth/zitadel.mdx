---
title: Configure ZITADEL Authentication Service for WodeChat
description: >-
  Learn how to configure ZITADEL Authentication Service for WodeChat deployment, including creating ZITADEL applications, setting up environment variables, and enabling single sign-on (SSO).
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that WodeChat is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use WodeChat using existing
