---
title: Using Google Gemini API Key in WodeChat
description: >-
  Learn how to integrate and utilize Google Gemini AI in WodeChat to enhance your conversational experience. Follow these steps to configure Google Gemini and start leveraging its powerful capabilities.
...
# Using Google Gemini in WodeChat

<Image alt={'Using Google Gemini in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913'} />
...
This document will guide you on how to use Google Gemini in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure OpenAI in WodeChat

  - Go to the `Settings` interface in WodeChat
  - Find the setting for `Google Gemini` under `Language Models`

  <Image alt={'Enter Google Gemini API Key in WodeChat'} inStep src={'https://github.com/lobehub/lobe-chat/assets/34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c'} />
...
Congratulations! You can now use Google Gemini in WodeChat.
