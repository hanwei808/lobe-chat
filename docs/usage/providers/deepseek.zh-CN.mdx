---
title: 在 WodeChat 中使用 DeepSeek API Key
description: 学习如何在 WodeChat 中配置和使用 DeepSeek 语言模型，获取 API 密钥并开始对话。
tags:
  - WodeChat
  - DeepSeek
  - API密钥
...
# 在 WodeChat 中使用 DeepSeek

<Image alt={'在 WodeChat 中使用 DeepSeek'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52'} />

[DeepSeek](https://www.deepseek.com/) 是一款先进的开源大型语言模型（LLM）。最新版本 DeepSeek-V2 在架构和性能上进行了显著优化，同时训练成本降低了 42.5%, 推理成本降低了 93.3%。

本文档将指导你如何在 WodeChat 中使用 DeepSeek:
...
<Steps>
  ...
  ### 步骤二：在 WodeChat 中配置 DeepSeek

  - 访问 WodeChat 的 `应用设置`界面
...
至此你已经可以在 WodeChat 中使用 Deepseek 提供的模型进行对话了。
