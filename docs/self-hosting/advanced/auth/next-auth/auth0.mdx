---
title: Configure Auth0 Identity Verification Service for WodeChat
description: >-
  Learn how to configure Auth0 Identity Verification Service for WodeChat for your organization, including creating applications, adding users, and configuring environment variables.
...
<Steps>
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to WodeChat.
...
<Callout>
  After successful deployment, users will be able to authenticate and use WodeChat using the users
  configured in Auth0.
</Callout>
...
<Callout type={'warning'}>
  ...
  WodeChat being abused by external users.
</Callout>
