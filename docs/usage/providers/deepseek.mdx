---
title: Using DeepSeek API Key in WodeChat
description: >-
  Learn how to use DeepSeek-V2 in WodeChat, obtain API keys. Get started with DeepSeek integration now!
...
# Using DeepSeek in WodeChat

<Image alt={'Using DeepSeek in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52'} />
...
This document will guide you on how to use DeepSeek in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in WodeChat

  - Access the `App Settings` interface in WodeChat.
...
You can now engage in conversations using the models provided by Deepseek in WodeChat.
