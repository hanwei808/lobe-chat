...
description: >-
  Learn how to import and export configuration settings for WodeChat via URL. Understand the supported settings, URL format, and parameter schema for keyVaults and languageModel.
...
WodeChat support import settings from external URL to quickly set up WodeChat configuration.
...
<Callout type={'warning'}>
  WodeChat does not verify the correctness of the settings parameters in the URL, nor provide
