---
title: Using Upstage in WodeChat
description: Learn how to integrate and utilize Upstage's language model APIs in WodeChat.
tags:
  - WodeChat
  - Upstage
  - API Key
...
This article will guide you on how to use Upstage in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in WodeChat
...
You can now use the models provided by Upstage for conversations in WodeChat.
