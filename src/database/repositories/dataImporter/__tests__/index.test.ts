          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'WodeChat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for WodeChat.',
                tags: [
                ...
                title: 'WodeChat Technical Documentation Expert',
              },
              type: 'agent',
