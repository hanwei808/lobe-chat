---
title: Configure Wechat Authentication Service in WodeChat
description: >-
  Learn how to configure Wechat authentication service in WodeChat, including creating a new Wechat App, setting permissions, and environment variables.
