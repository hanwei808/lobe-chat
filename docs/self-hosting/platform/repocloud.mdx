---
title: Deploy WodeChat on RepoCloud
description: >-
  Learn how to deploy WodeChat on RepoCloud with ease. Follow these steps to prepare your OpenAI API Key, deploy the application, and start using it. Optional: Bind a custom domain for a personalized touch.
...
# Deploy WodeChat with RepoCloud

If you want to deploy WodeChat on RepoCloud, you can follow the steps below:
