---
title: >-
  Troubleshooting `OPENAI_PROXY_URL` in WodeChat Configuration for Empty Response

description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response after configuring the WodeChat `OPENAI_PROXY_URL` environment variable.
