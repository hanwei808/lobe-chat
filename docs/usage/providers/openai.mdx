---
title: Using OpenAI API Key in WodeChat
description: >-
  Learn how to integrate OpenAI API Key in WodeChat. Support GPT-4o / GPT-4-turbo / GPT-4-vision
...
# Using OpenAI in WodeChat

<Image alt={'Using OpenAI in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'} />

This document will guide you on how to use [OpenAI](https://openai.com/) in WodeChat:
...
<Steps>
  ...
  - Visit the `Settings` page in WodeChat
...
You can now engage in conversations using the models provided by OpenAI in WodeChat.
