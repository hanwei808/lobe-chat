---
title: Configuring Authentik Authentication Service for WodeChat
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for WodeChat, including creating an application provider, setting environment variables, and deployment instructions.
