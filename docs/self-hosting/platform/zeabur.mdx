---
title: Deploy WodeChat on Zeabur
description: >-
...
# Deploy WodeChat with Zeabur

If you want to deploy WodeChat on Zeabur, you can follow the steps below:
...
# Deploy WodeChat with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy WodeChat as a serverless function service. To deploy WodeChat as a serverless function service on Zeabur, you can follow the steps below:
...
<Steps>
  ...
  ### Link your fork of WodeChat to the just created Zeabur service.
