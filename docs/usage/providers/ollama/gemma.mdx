---
title: Using Google Gemma Model in WodeChat
description: >-
  Learn how to integrate and utilize Google Gemma in WodeChat, an open-source large language model, in WodeChat with the help of Ollama. Follow these steps to pull and select the Gemma model for natural language processing tasks.
...
<Image alt={'Using Gemma in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/17870709/65d2dd2a-fdcf-4f3f-a6af-4ed5164a510d'} />

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of WodeChat and [Ollama](https://ollama.com/), you can easily use Google Gemma in WodeChat.

This document will guide you on how to use Google Gemma in WodeChat:
...
Now, you can start conversing with the local Gemma model using WodeChat.
