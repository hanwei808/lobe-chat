---
title: 在 WodeChat 中使用 Fireworks AI
description: 学习如何在 WodeChat 中配置和使用 Fireworks AI 的API Key，以便开始对话和交互。
tags:
  - WodeChat
  - Fireworks AI
  - API密钥
...
本文将指导你如何在 WodeChat 中使用 Fireworks AI。
...
<Steps>
  ...
  ### 步骤二：在 WodeChat 中配置 Fireworks AI
...
至此你已经可以在 WodeChat 中使用 Fireworks AI 提供的模型进行对话了。
