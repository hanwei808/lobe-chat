---
title: Configuring Github Authentication Service for WodeChat
description: >-
  Learn how to configure Github authentication service for WodeChat, including creating a Github provider, setting up environment variables, and deploying WodeChat.
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for WodeChat. Use `github` for Github.                                                                                                                             |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use WodeChat.
</Callout>
