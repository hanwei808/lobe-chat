---
title: 在 WodeChat 中使用腾讯混元
description: 学习如何在 WodeChat 中配置和使用腾讯混元的API Key，以便开始对话和交互。
tags:
  - WodeChat
  - 腾讯混元
  - API密钥
...
至此你已经可以在 WodeChat 中使用腾讯混元提供的模型进行对话了。
