---
title: Using iFLYTEK Spark in WodeChat
description: Learn how to integrate and utilize iFLYTEK's Spark model APIs in WodeChat.
tags:
  - WodeChat
  - iFLYTEK
  - Spark
...
# Using iFLYTEK Spark in WodeChat
...
This guide will instruct you on how to use iFLYTEK Spark in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in WodeChat

  - Access the `Settings` menu in WodeChat
...
Now you can use the models provided by iFLYTEK Spark for conversations in WodeChat.
