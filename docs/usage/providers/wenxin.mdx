---
title: Using Wenxin Qianfan in WodeChat
description: >-
  Learn how to integrate and utilize Wenxin Qianfan's language model APIs in WodeChat.
...
# Using Wenxin Qianfan in WodeChat
...
This article will guide you on how to use Wenxin Qianfan in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in WodeChat

  - Go to the `Settings` page of WodeChat
...
You can now use the models provided by Wenxin Qianfan for conversations in WodeChat.
