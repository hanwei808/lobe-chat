---
title: WodeChat Supports Sharing Conversations in Text Format (Markdown/JSON)
description: >-
  WodeChat v1.28.0 introduces support for exporting conversations in Markdown and OpenAI format JSON, making it easy to convert conversation content into note materials, development debugging data, and training corpora, significantly enhancing the reusability of conversation content.
