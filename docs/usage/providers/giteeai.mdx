---
title: Using Gitee AI in WodeChat
description: >-
  Learn how to configure and use Gitee AI's API Key in WodeChat to start conversations and interactions.
...
This article will guide you on how to use Gitee AI in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure Gitee AI in WodeChat

  - Access the `Settings` page in WodeChat
...
Now you can start having conversations using the models provided by Gitee AI in WodeChat!
