---
title: Deploy WodeChat with Database on RepoCloud
description: >-
  Learn how to deploy WodeChat on RepoCloud with ease, including database, authentication and S3 storage service.
...
# Deploying WodeChat Database Edition with RepoCloud

If you want to deploy WodeChat Database Edition on RepoCloud, you can follow the steps below:
