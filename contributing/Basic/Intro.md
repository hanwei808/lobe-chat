...
Welcome to the WodeChat Technical Development Getting Started Guide. WodeChat is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of WodeChat and how to configure and use these technologies in your development environment.
...
The core technology stack of WodeChat is as follows:
...
The folder directory structure of WodeChat is as follows:
...
1. **Get the code**: Clone the WodeChat code repository locally:
...
WodeChat uses `i18next` and `lobe-i18n` to implement multilingual support, ensuring a global user experience.
...
To support developers in better understanding and using the technology stack of WodeChat, we provide a comprehensive list of resources and references — [WodeChat Resources and References](https://github.com/lobehub/lobe-chat/wiki/Resources.zh-CN) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [WodeChat GitHub Discussions](https://github.com/lobehub/lobe-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
