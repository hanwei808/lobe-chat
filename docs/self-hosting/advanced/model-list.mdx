---
title: Customizing Provider Model List in WodeChat for Deployment
description: >-
  Learn how to customize the model list in WodeChat for deployment with the syntax and extension capabilities
...
WodeChat supports customizing the model list during deployment. This configuration is done in the environment for each [model provider](/docs/self-hosting/environment-variables/model-provider).
