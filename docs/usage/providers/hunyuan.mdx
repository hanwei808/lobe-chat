---
title: Using Tencent Hunyuan in WodeChat
description: >-
  Learn how to integrate and utilize Tencent Hunyuan's language model APIs in WodeChat.
...
# Using Tencent Hunyuan in WodeChat
...
This article will guide you on how to use Tencent Hunyuan in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in WodeChat

  - Go to the `Settings` page in WodeChat
...
You can now engage in conversations using the models provided by Tencent Hunyuan in WodeChat.
