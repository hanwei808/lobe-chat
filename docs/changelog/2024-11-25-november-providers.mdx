---
title: New Model Providers Added to WodeChat in November
description: >-
  WodeChat model providers now support Gitee AI, InternLM (ShuSheng PuYu), xAI, and Cloudflare WorkersAI
...
# New Model Providers Added to WodeChat in November 🎉

We're excited to announce that WodeChat has expanded its AI model support with the following providers:
