---
title: Using Cloudflare Workers AI in WodeChat
description: Learn how to integrate and utilize Cloudflare Workers AI Models in WodeChat.
tags:
  - WodeChat
  - Cloudflare
  - Workers AI
...
# Using Cloudflare Workers AI in WodeChat
...
This document will guide you on how to use Cloudflare Workers AI in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in WodeChat
...
At this point, you can start conversing with the model provided by Cloudflare Workers AI in WodeChat.
