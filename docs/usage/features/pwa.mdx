---
title: WodeChat support Progressive Web Apps (PWA)
description: >-
  Discover how WodeChat utilizes Progressive Web App (PWA) technology to provide a seamless and near-native app experience on both desktop and mobile devices. Learn how to install WodeChat as a desktop app for enhanced convenience.
...
<Callout type={'tip'}>
  The default installed WodeChat PWA icon has a black background, you can use <kbd>cmd</kbd> +{' '}
