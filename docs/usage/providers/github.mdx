---
title: Using GitHub Models in WodeChat
description: Learn how to integrate and utilize GitHub Models in WodeChat.
tags:
  - WodeChat
  - GitHub
  - GitHub Models
...
# Using GitHub Models in WodeChat
...
This article will guide you on how to use GitHub Models in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in WodeChat

  - Navigate to the `Settings` interface in WodeChat.
...
You are now ready to use the models provided by GitHub for conversations within WodeChat.
