---
title: Using Minimax API Key in WodeChat
description: >-
  Learn how to use MiniMax in WodeChat to enhance AI conversations. Obtain MiniMax API key, configure MiniMax in WodeChat settings, and select a model for your AI assistant.
...
# Using Minimax in WodeChat

<Image alt={'Using Minimax in WodeChat'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/703f170b-c03b-4c71-b57d-c2357596bdfb'} />
...
This document will guide you on how to use Minimax in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in WodeChat

  - Go to the `Settings` interface of WodeChat
...
You can now use the models provided by MiniMax to have conversations in WodeChat.
