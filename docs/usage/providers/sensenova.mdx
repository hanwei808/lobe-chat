---
title: Using SenseNova in WodeChat
description: >-
...
This article will guide you on how to use SenseNova in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in WodeChat

  - Access the `Settings` interface on WodeChat.
...
You can now have conversations using the models provided by SenseNova in WodeChat.
