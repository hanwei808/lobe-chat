---
title: Deploy WodeChat with Vercel
description: >-
  Learn how to deploy WodeChat on Vercel with ease. Follow the provided steps to prepare your OpenAI API Key, deploy the project, and start using it efficiently.
...
# Deploy WodeChat with Vercel

If you want to deploy WodeChat on Vercel, you can follow the steps below:
