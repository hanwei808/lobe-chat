...
description: >-
  Explore how WodeChat integrates visual recognition capabilities into large language models, enabling multimodal interactions for enhanced user experiences.
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, WodeChat now supports various large language models with visual recognition capabilities, enabling WodeChat to have multimodal interaction capabilities.
