---
title: Deploy WodeChat with Docker Compose
description: >-
  Learn how to deploy the WodeChat service using Docker Compose. Follow step-by-step instructions to install Docker, run the deployment command, and set up automatic updates.
...
We provide a [Docker image][docker-release-link] for deploying the WodeChat service on your private device.
