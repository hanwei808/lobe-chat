---
title: Using xAI in WodeChat
description: >-
  Learn how to configure and use xAI's API Key in WodeChat to start conversations and interactions.
...
This article will guide you on how to use xAI in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure xAI in WodeChat

  - Go to the `Settings` menu in WodeChat
...
You are now ready to engage in conversations using the models provided by xAI in WodeChat.
