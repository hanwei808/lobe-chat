---
title: Using InternLM in WodeChat
description: >-
  Learn how to configure and use SenseNova's API Key in WodeChat to start conversations and interactions.
...
This article will guide you on how to use InternLM in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in WodeChat
...
You are now ready to engage in conversations using the models provided by InternLM in WodeChat.
