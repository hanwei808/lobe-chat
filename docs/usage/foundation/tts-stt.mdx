---
title: Guide to Text-to-Speech Conversion - WodeChat TTS Feature
description: >-
  Learn how to use WodeChat's text-to-speech (TTS) feature for voice input and output. Explore speech-to-text (STT) functionality and customize TTS settings.
...
WodeChat supports text-to-speech conversion, allowing users to input content through voice and have the AI output read aloud through speech.
...
Select the voice input feature in the input window, and WodeChat will convert your speech to text and input it into the text box. After completing the input, you can send it directly to the AI.
