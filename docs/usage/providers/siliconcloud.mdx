---
title: Using SiliconCloud in WodeChat
description: >-
  Learn how to integrate and utilize SiliconCloud's language model APIs in WodeChat.
...
# Using SiliconCloud in WodeChat
...
This article will guide you on how to use SiliconCloud in WodeChat.
...
<Steps>
  ...
  ### Step 2: Configure SiliconCloud in WodeChat
...
At this point, you can start chatting using the models provided by SiliconCloud in WodeChat.
