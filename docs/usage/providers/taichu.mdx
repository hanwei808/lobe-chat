---
title: Using Taichu API Key in WodeChat
description: >-
  Learn how to integrate Taichu AI into WodeChat for enhanced conversational experiences. Follow the steps to configure Taichu AI and start using its models.
...
# Using Taichu in WodeChat

<Image alt={'Using Taichu in WodeChat'} cover src={'https://github.com/user-attachments/assets/9cb27b68-f2ac-4ff9-8f97-d96314b1af03'} />

This article will guide you on how to use Taichu in WodeChat:
...
<Steps>
  ...
  ### Step 2: Configure Taichu in WodeChat
...
Now you can start conversing with the models provided by Taichu in WodeChat.
